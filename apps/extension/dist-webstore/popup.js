...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initMainApp() {
    ...
    const communitySubmitCommentBtn = document.getElementById("community-submit-comment-btn");
    const communityCommentInput = document.getElementById("community-comment-input");
    const communityCommentStatus = document.getElementById("community-comment-status");
    const communityFlagButtons = document.querySelectorAll(".community-flag-btn");
    const communityFeedbackResults = document.getElementById("community-feedback-results");
    const communityFeedbackState = document.getElementById("community-feedback-state");
    const communityFeedbackList = document.getElementById("community-feedback-list");
    ...
    function renderFeedbackList(reports) {
      ...
      communityFeedbackList.innerHTML = reports
        .map((report) => {
          const rawFlag = typeof report?.flag === "string" ? report.flag.toLowerCase() : "neutral";
          const flag = ["phishing", "legitimate", "neutral"].includes(rawFlag) ? rawFlag : "neutral";
          const label = flag === "phishing" ? "Dangerous" : flag === "legitimate" ? "Safe" : "Neutral";
          const description =
