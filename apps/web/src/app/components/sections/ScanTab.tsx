      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 text-center shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/signup"
              className="bg-white hover:bg-gray-50 text-[#6B73FF] border border-[#6B73FF] px-8 py-3 rounded-lg font-semibold transition-all duration-300"
            >
              Create Account
            </Link>
          </div>
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading your scans...</p>
        </div>
      </div>
    );
  }
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                  <th className="text-left px-6 py-4 text-gray-700 dark:text-gray-300 font-semibold text-sm uppercase tracking-wider">
                    URL / Domain
                  </th>
                  <th className="text-left px-6 py-4 text-gray-700 dark:text-gray-300 font-semibold text-sm uppercase tracking-wider">
                    Time
                  </th>
                  <th className="text-right px-6 py-4 text-gray-700 dark:text-gray-300 font-semibold text-sm uppercase tracking-wider">
                    Risk Analysis
                  </th>
                </tr>
              </thead>
