...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Random Forest, Decision Tree, Naive Bayes, and a meta-learner each cast an independent verdict.",
    metric: "4-model",
...
function ScannerDemo({
  ...
  useEffect(() => {
    ...
    url.split("").forEach((_, i) => {
      if (i % 3 === 0) add(() => setTypedUrl(url.slice(0, i + 3)), i * 28);
    });
    const t1 = url.length * 28 + 300;
    ...
    add(() => setP("verdict"), t4);
    add(() => setIdx((prev) => (prev + 1) % DEMOS.length), t4 + 3600);

    return clearAll;
  }, [idx, isActive, add, clearAll, setP, onPhaseChange]);

  const demo = DEMOS[idx];

  return (
    <div className="w-full rounded-2xl overflow-hidden border dark:border-white/[0.07] border-slate-200 dark:bg-[#08090f] bg-white shadow-lg shadow-black/5 dark:shadow-black/30">
      {/* Title bar */}
      <div className="flex items-center gap-2 px-4 py-2.5 border-b dark:border-white/[0.06] border-slate-100 dark:bg-[#0c0d17] bg-slate-50">
        ...
        <span className="ml-3 font-mono text-[10px] tracking-widest text-[#545BFF] uppercase select-none">
          SmartShield · Detection Engine
        </span>
        <div className="ml-auto flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-[#22c55e] animate-pulse" />
          <span className="font-mono text-[9px] dark:text-slate-500 text-slate-400 uppercase tracking-widest">Live</span>
        </div>
      </div>

      {/* URL bar */}
      <div className="px-4 py-2 border-b dark:border-white/[0.05] border-slate-100">
      ...
      <div className="relative h-[380px] overflow-hidden">
        ...
        {/* Feature Extraction */}
        <div
          className="absolute inset-0 px-4 py-3 transition-all duration-400"
        ...
        >
          <div className="flex items-center gap-2 mb-2.5">
            ...
            <span className="font-mono text-[9px] opacity-60" style={{ color: "#34d399" }}>{demo.features.length} signals</span>
          </div>
          ...
          <div className="flex flex-col gap-3">
            {demo.models.map((m, i) => (
              <div key={i} className="flex items-center gap-3">
                <span className="font-mono text-[9px] dark:text-slate-400 text-slate-500 w-[104px] shrink-0 truncate">{m.name}</span>
        ...
        {/* Verdict */}
        <div
          className="absolute inset-0 px-4 flex flex-col justify-center gap-3 transition-all duration-400"
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              { label: "Features", value: `${demo.features.length} signals`, color: "#34d399" },
      ...
      {/* Footer */}
      <div className="px-4 py-2 border-t dark:border-white/[0.05] border-slate-100 dark:bg-[#0c0d17] bg-slate-50 flex items-center gap-2">
        <span className="w-1.5 h-1.5 rounded-full bg-[#22c55e] animate-pulse" />
    ...
    <div className="relative flex gap-4 sm:gap-5">
      ...
      <div className="flex flex-col items-center shrink-0">
        <motion.div
          ...
          className="relative w-10 h-10 rounded-full flex items-center justify-center font-black font-mono text-[13px] z-10 transition-all duration-500"
          style={{
            background: isActive
      ...
      <motion.div
        ...
        className={`flex-1 ${isLast ? "pb-0" : "pb-7"}`}
      >
        <span
        ...
        <p className="text-[13px] sm:text-sm text-copy leading-relaxed">{step.desc}</p>
...
export default function HowItWorks() {
  ...
  return (
    <section ref={ref} className="relative py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-page overflow-hidden">
      {/* Subtle background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full bg-[#545BFF]/[0.04] blur-[100px]" />
        <div
          className="absolute inset-0 dark:opacity-[0.025] opacity-[0.018]"
          style={{
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border dark:border-[#545BFF]/25 border-[#545BFF]/20 dark:bg-[#545BFF]/[0.07] bg-[#545BFF]/[0.05] mb-4"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-faded max-w-xl mx-auto leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-stretch">
          ...
          <motion.div
            ...
            className="lg:order-2 lg:sticky lg:top-24 flex flex-col gap-3"
          >
