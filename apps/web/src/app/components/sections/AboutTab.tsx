  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-faded max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="bg-gradient-to-br from-[#6B73FF]/5 to-purple-500/5 rounded-3xl p-8 md:p-12 mb-12 border border-[#6B73FF]/10">
        <div className="flex items-start gap-6">
          ...
          <div>
            ...
            <p className="text-copy leading-relaxed text-lg">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <div className="bg-panel rounded-2xl p-8 border border-divider hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
      ...
      {/* Technology Section */}
      <div className="bg-panel rounded-3xl p-8 md:p-12 border border-divider">
