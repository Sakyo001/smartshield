...
export default function HeroSection() {
  return (
    <section className="relative pt-32 pb-20 px-6 bg-gradient-to-br from-[#0a0a0f] via-[#1a1a2e] to-[#16213e] overflow-hidden">
      {/* Background gradient effects */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#545BFF]/20 rounded-full blur-[120px]"></div>
