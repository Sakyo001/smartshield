        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-black mb-3 transition-colors">
                {feature.title}
              </h3>
              <p className="text-gray-600 dark:text-gray-600 text-sm leading-relaxed transition-colors">
                {feature.description}
              </p>
            </div>
          ))}
