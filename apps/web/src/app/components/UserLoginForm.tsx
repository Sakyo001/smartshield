          ...
          <div className="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center lg:rounded-r-2xl rounded-2xl lg:rounded-l-none bg-white border lg:border-l-0 border-gray-200">
            ...
            <div className="mb-8 flex justify-center ">
              <div className="flex items-center gap-2 mb-2">
                <Image src="/images/miniloginlogo.png" alt="SmartShield" width={32} height={32} />
                <span className="text-2xl font-bold text-gray-900">SmartShield</span>
              </div>
            </div>
            ...
            <p className="text-center text-gray-600 text-sm mt-8">
              Don't have an account? <Link href="/signup" className="text-[#545BFF] hover:underline font-semibold">Sign up</Link>
            </p>
          </div>
        </div>
      </div>
