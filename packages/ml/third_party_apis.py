...
BRAND_REGISTRY: Dict[str, Tuple[str, str, str]] = {
    ...
    "boc":              ("boc.com.ph",           "Bank of Commerce Philippines",         "PH Bank"),
    "suneast":          ("suneast.ph",           "Sun East Rural Bank",                  "PH Bank"),
    # ── Philippine digital / e-money ──────────────────────────────────────
    ...
    "gcash":            ("gcash.com",            "GCash",                                "PH E-Money"),
    "paymaya":          ("paymaya.com",          "PayMaya",                              "PH E-Money"),
    "maya":             ("maya.ph",              "Maya",                                 "PH E-Money"),
    "coins":            ("coins.ph",             "Coins.ph",                             "PH E-Money"),
    "grabpay":          ("grab.com",             "GrabPay",                              "PH E-Money"),
    "shopeepay":        ("shopee.ph",            "ShopeePay",                            "PH E-Money"),
    "instapay":         ("instapay.ph",          "InstaPay",                             "PH E-Money"),
    "pesonet":          ("pesonet.ph",           "PESONet",                              "PH E-Money"),
    # ── Philippine government ──────────────────────────────────────────────
    "sss":              ("sss.gov.ph",           "Social Security System",               "PH Government"),
    "gsis":             ("gsis.gov.ph",          "GSIS",                                 "PH Government"),
    "pagibig":          ("pagibig.gov.ph",       "Pag-IBIG Fund",                        "PH Government"),
    "philhealth":       ("philhealth.gov.ph",    "PhilHealth",                           "PH Government"),
    "bir":              ("bir.gov.ph",           "Bureau of Internal Revenue",           "PH Government"),
    "lto":              ("lto.gov.ph",           "Land Transportation Office",           "PH Government"),
    "nso":              ("psa.gov.ph",           "Philippine Statistics Authority",      "PH Government"),
    "psa":              ("psa.gov.ph",           "Philippine Statistics Authority",      "PH Government"),
    "dfa":              ("dfa.gov.ph",           "Department of Foreign Affairs",        "PH Government"),
    "comelec":          ("comelec.gov.ph",       "COMELEC",                              "PH Government"),
    "philpost":         ("philpost.gov.ph",      "Philippine Postal Corporation",        "PH Government"),
    # ── Philippine telco & utilities ──────────────────────────────────────
    "globe":            ("globe.com.ph",         "Globe Telecom",                        "PH Telco"),
    "smart":            ("smart.com.ph",         "Smart Communications",                 "PH Telco"),
    "pldt":             ("pldt.com",             "PLDT",                                 "PH Telco"),
    "dito":             ("dito.ph",              "DITO Telecommunity",                   "PH Telco"),
    "converge":         ("convergeict.com",      "Converge ICT",                         "PH Telco"),
    "skycable":         ("skycable.com",         "Sky Cable",                            "PH Telco"),
    "meralco":          ("meralco.com.ph",       "Meralco",                              "PH Utility"),
    "maynilad":         ("mayniladwater.com.ph", "Maynilad Water Services",              "PH Utility"),
    "mwd":              ("mwd.gov.ph",           "Metropolitan Waterworks",              "PH Utility"),
    # ── Philippine e-commerce & delivery ──────────────────────────────────
    "lazada":           ("lazada.com.ph",        "Lazada Philippines",                   "PH E-Commerce"),
    "shopee":           ("shopee.ph",            "Shopee Philippines",                   "PH E-Commerce"),
    "zalora":           ("zalora.com.ph",        "Zalora Philippines",                   "PH E-Commerce"),
    "grab":             ("grab.com",             "Grab Philippines",                     "PH Ride/Delivery"),
    "angkas":           ("angkas.com",           "Angkas",                               "PH Ride"),
    "jrs":              ("jrs.com.ph",           "JRS Express",                          "PH Delivery"),
    "lbc":              ("lbcexpress.com",       "LBC Express",                          "PH Delivery"),
    "jnt":              ("jntexpress.com.ph",    "J&T Express",                          "PH Delivery"),
    "ninjavan":         ("ninjavan.com",         "Ninja Van",                            "PH Delivery"),
    "2go":              ("2go.com.ph",           "2GO",                                  "PH Delivery"),
    # ── International banks ────────────────────────────────────────────────
    ...
    "wellsfargo":       ("wellsfargo.com",       "Wells Fargo",                          "Intl Bank"),
    "barclays":         ("barclays.com",         "Barclays",                             "Intl Bank"),
    "bnpparibas":       ("bnpparibas.com",       "BNP Paribas",                          "Intl Bank"),
    "creditsuisse":     ("credit-suisse.com",    "Credit Suisse",                        "Intl Bank"),
    "ubs":              ("ubs.com",              "UBS",                                  "Intl Bank"),
    "ing":              ("ing.com",              "ING",                                  "Intl Bank"),
    "santander":        ("santander.com",        "Santander",                            "Intl Bank"),
    "commbank":         ("commbank.com.au",      "Commonwealth Bank",                    "Intl Bank"),
    "nab":              ("nab.com.au",           "National Australia Bank",              "Intl Bank"),
    "westpac":          ("westpac.com.au",       "Westpac",                              "Intl Bank"),
    "icbc":             ("icbc.com.cn",          "ICBC",                                 "Intl Bank"),
    "dbs":              ("dbs.com",              "DBS Bank",                             "Intl Bank"),
    "ocbc":             ("ocbc.com",             "OCBC Bank",                            "Intl Bank"),
    "uob":              ("uob.com",              "UOB",                                  "Intl Bank"),
    "capitalone":       ("capitalone.com",       "Capital One",                          "Intl Bank"),
    "amex":             ("americanexpress.com",  "American Express",                     "Intl Bank"),
    "americanexpress":  ("americanexpress.com",  "American Express",                     "Intl Bank"),
    # ── Global tech / FAANG ───────────────────────────────────────────────
    ...
    "hotmail":          ("hotmail.com",          "Hotmail",                              "Tech"),
    "onedrive":         ("onedrive.live.com",    "OneDrive",                             "Tech"),
    "azure":            ("azure.microsoft.com",  "Microsoft Azure",                      "Tech"),
    "apple":            ("apple.com",            "Apple",                                "Tech"),
    "icloud":           ("icloud.com",           "iCloud",                               "Tech"),
    "itunes":           ("apple.com",            "iTunes / App Store",                   "Tech"),
    "amazon":           ("amazon.com",           "Amazon",                               "Tech"),
    "aws":              ("aws.amazon.com",       "Amazon Web Services",                  "Tech"),
    "facebook":         ("facebook.com",         "Facebook",                             "Social"),
    "instagram":        ("instagram.com",        "Instagram",                            "Social"),
    "whatsapp":         ("whatsapp.com",         "WhatsApp",                             "Social"),
    "messenger":        ("messenger.com",        "Facebook Messenger",                   "Social"),
    "twitter":          ("twitter.com",          "Twitter / X",                          "Social"),
    "linkedin":         ("linkedin.com",         "LinkedIn",                             "Social"),
    "tiktok":           ("tiktok.com",           "TikTok",                               "Social"),
    "snapchat":         ("snapchat.com",         "Snapchat",                             "Social"),
    "pinterest":        ("pinterest.com",        "Pinterest",                            "Social"),
    "reddit":           ("reddit.com",           "Reddit",                               "Social"),
    "discord":          ("discord.com",          "Discord",                              "Social"),
    "telegram":         ("telegram.org",         "Telegram",                             "Social"),
    "signal":           ("signal.org",           "Signal",                               "Social"),
    "viber":            ("viber.com",            "Viber",                                "Social"),
    "wechat":           ("wechat.com",           "WeChat",                               "Social"),
    "line":             ("line.me",              "LINE",                                 "Social"),
    # ── E-commerce / Payments ─────────────────────────────────────────────
    "paypal":           ("paypal.com",           "PayPal",                               "Payment"),
    "stripe":           ("stripe.com",           "Stripe",                               "Payment"),
    "wise":             ("wise.com",             "Wise",                                 "Payment"),
    "skrill":           ("skrill.com",           "Skrill",                               "Payment"),
    "neteller":         ("neteller.com",         "Neteller",                             "Payment"),
    "venmo":            ("venmo.com",            "Venmo",                                "Payment"),
    "cashapp":          ("cash.app",             "Cash App",                             "Payment"),
    "zelle":            ("zellepay.com",         "Zelle",                                "Payment"),
    "visa":             ("visa.com",             "Visa",                                 "Payment"),
    "mastercard":       ("mastercard.com",       "Mastercard",                           "Payment"),
    "ebay":             ("ebay.com",             "eBay",                                 "E-Commerce"),
    "aliexpress":       ("aliexpress.com",       "AliExpress",                           "E-Commerce"),
    "alibaba":          ("alibaba.com",          "Alibaba",                              "E-Commerce"),
    "etsy":             ("etsy.com",             "Etsy",                                 "E-Commerce"),
    "walmart":          ("walmart.com",          "Walmart",                              "E-Commerce"),
    "target":           ("target.com",           "Target",                               "E-Commerce"),
    "bestbuy":          ("bestbuy.com",          "Best Buy",                             "E-Commerce"),
    # ── Streaming / Entertainment ─────────────────────────────────────────
    "netflix":          ("netflix.com",          "Netflix",                              "Streaming"),
    "spotify":          ("spotify.com",          "Spotify",                              "Streaming"),
    "disneyplus":       ("disneyplus.com",       "Disney+",                              "Streaming"),
    "hbomax":           ("max.com",              "Max (HBO)",                            "Streaming"),
    "hulu":             ("hulu.com",             "Hulu",                                 "Streaming"),
    "primevideo":       ("primevideo.com",       "Prime Video",                          "Streaming"),
    "twitch":           ("twitch.tv",            "Twitch",                               "Streaming"),
    "dazn":             ("dazn.com",             "DAZN",                                 "Streaming"),
    # ── Crypto exchanges ──────────────────────────────────────────────────
    "binance":          ("binance.com",          "Binance",                              "Crypto"),
    "coinbase":         ("coinbase.com",         "Coinbase",                             "Crypto"),
    "kraken":           ("kraken.com",           "Kraken",                               "Crypto"),
    "bitfinex":         ("bitfinex.com",         "Bitfinex",                             "Crypto"),
    "kucoin":           ("kucoin.com",           "KuCoin",                               "Crypto"),
    "okx":              ("okx.com",              "OKX",                                  "Crypto"),
    "bybit":            ("bybit.com",            "Bybit",                                "Crypto"),
    "gemini":           ("gemini.com",           "Gemini",                               "Crypto"),
    "cryptocom":        ("crypto.com",           "Crypto.com",                           "Crypto"),
    "metamask":         ("metamask.io",          "MetaMask",                             "Crypto"),
    "trustwallet":      ("trustwallet.com",      "Trust Wallet",                         "Crypto"),
    "ledger":           ("ledger.com",           "Ledger",                               "Crypto"),
    "trezor":           ("trezor.io",            "Trezor",                               "Crypto"),
    "opensea":          ("opensea.io",           "OpenSea",                              "Crypto/NFT"),
    # ── Cloud / SaaS ──────────────────────────────────────────────────────
    "dropbox":          ("dropbox.com",          "Dropbox",                              "Cloud"),
    "box":              ("box.com",              "Box",                                  "Cloud"),
    "slack":            ("slack.com",            "Slack",                                "Cloud"),
    "zoom":             ("zoom.us",              "Zoom",                                 "Cloud"),
    "salesforce":       ("salesforce.com",       "Salesforce",                           "Cloud"),
    "hubspot":          ("hubspot.com",          "HubSpot",                              "Cloud"),
    "atlassian":        ("atlassian.com",        "Atlassian",                            "Cloud"),
    "jira":             ("atlassian.com",        "Jira (Atlassian)",                     "Cloud"),
    "notion":           ("notion.so",            "Notion",                               "Cloud"),
    "github":           ("github.com",           "GitHub",                               "Tech"),
    "gitlab":           ("gitlab.com",           "GitLab",                               "Tech"),
    "adobe":            ("adobe.com",            "Adobe",                                "Tech"),
    "docusign":         ("docusign.com",         "DocuSign",                             "Tech"),
    "squarespace":      ("squarespace.com",      "Squarespace",                          "Tech"),
    "wordpress":        ("wordpress.com",        "WordPress",                            "Tech"),
    "shopify":          ("shopify.com",          "Shopify",                              "Tech"),
    "godaddy":          ("godaddy.com",          "GoDaddy",                              "Tech"),
    "cloudflare":       ("cloudflare.com",       "Cloudflare",                           "Tech"),
    # ── Gaming ────────────────────────────────────────────────────────────
    "steam":            ("store.steampowered.com","Steam",                               "Gaming"),
    "epicgames":        ("epicgames.com",        "Epic Games",                           "Gaming"),
    "roblox":           ("roblox.com",           "Roblox",                               "Gaming"),
    "minecraft":        ("minecraft.net",        "Minecraft",                            "Gaming"),
    "ea":               ("ea.com",               "EA (Electronic Arts)",                 "Gaming"),
    "blizzard":         ("blizzard.com",         "Blizzard Entertainment",               "Gaming"),
    "playstation":      ("playstation.com",      "PlayStation",                          "Gaming"),
    "xbox":             ("xbox.com",             "Xbox",                                 "Gaming"),
    "nintendo":         ("nintendo.com",         "Nintendo",                             "Gaming"),
    "valoarnt":         ("playvalorant.com",     "Valorant",                             "Gaming"),
    # ── Logistics / Travel ────────────────────────────────────────────────
    "dhl":              ("dhl.com",              "DHL",                                  "Logistics"),
    "fedex":            ("fedex.com",            "FedEx",                                "Logistics"),
    "ups":              ("ups.com",              "UPS",                                  "Logistics"),
    "usps":             ("usps.com",             "USPS",                                 "Logistics"),
    "airfrance":        ("airfrance.com",        "Air France",                           "Travel"),
    "cebuair":          ("cebuair.com",          "Cebu Pacific",                         "Travel"),
    "philippineairlines":("philippineairlines.com","Philippine Airlines",                "Travel"),
    "pal":              ("philippineairlines.com","Philippine Airlines (PAL)",           "Travel"),
    "asianaspirits":    ("airasia.com",          "AirAsia",                              "Travel"),
    "airasia":          ("airasia.com",          "AirAsia",                              "Travel"),
    "booking":          ("booking.com",          "Booking.com",                          "Travel"),
    "airbnb":           ("airbnb.com",           "Airbnb",                               "Travel"),
    "expedia":          ("expedia.com",          "Expedia",                              "Travel"),
    "agoda":            ("agoda.com",            "Agoda",                                "Travel"),
    "klook":            ("klook.com",            "Klook",                                "Travel"),
    # ── Food / Delivery ───────────────────────────────────────────────────
    "foodpanda":        ("foodpanda.com.ph",     "Foodpanda",                            "Food Delivery"),
    "grabfood":         ("grab.com",             "GrabFood",                             "Food Delivery"),
    "ubereats":         ("ubereats.com",         "Uber Eats",                            "Food Delivery"),
    "jollibee":         ("jollibee.com.ph",      "Jollibee",                             "Food/Restaurant"),
    "mcdonalds":        ("mcdonalds.com.ph",     "McDonald's",                           "Food/Restaurant"),
    "kfc":              ("kfc.com.ph",           "KFC",                                  "Food/Restaurant"),
    "starbucks":        ("starbucks.com.ph",     "Starbucks",                            "Food/Restaurant"),
    # ── Insurance ─────────────────────────────────────────────────────────
    "sunlife":          ("sunlife.com.ph",       "Sun Life Philippines",                 "Insurance"),
    "aia":              ("aia.com.ph",           "AIA Philippines",                      "Insurance"),
    "prulife":          ("prulifeuk.com.ph",     "Pru Life UK",                          "Insurance"),
    "philamlife":       ("aia.com.ph",           "PhilamLife / AIA",                     "Insurance"),
    "insularlife":      ("insularlife.com.ph",   "Insular Life",                         "Insurance"),
    "bpiams":           ("bpiams.com",           "BPI AMS",                              "Insurance"),
    "metrolife":        ("metrolifeinsurance.com","Metro Life Insurance",                "Insurance"),
}
...
BRAND_KEYWORD_ALIASES: Dict[str, str] = {
    ...
    # PH Government
    "mybir": "bir", "bir-ph": "bir",
    "mysss": "sss", "sss-ph": "sss",
    "mygsis": "gsis",
    "mypagibig": "pagibig", "pagibigfund": "pagibig", "pag-ibig": "pagibig",
    "myphilhealth": "philhealth",
    # Intl Banks
    "citi": "citibank",
    "stanchart": "standardchartered", "standardch": "standardchartered",
    "boa": "bankofamerica", "bofa": "bankofamerica",
    "chase": "jpmorgan",
    "deutsche": "deutschebank", "db-bank": "deutschebank",
    "wf": "wellsfargo", "wellsfargoonline": "wellsfargo",
    "bny": "bankofamerica",
    "commbank-au": "commbank",
    # Tech / FAANG
    "google-login": "google", "googleaccount": "google",
    "gmail-login": "gmail", "mygmail": "gmail",
    "microsoftonline": "microsoft", "ms-login": "microsoft",
    "office365": "microsoft", "o365": "microsoft", "msoffice": "microsoft",
    "appleid": "apple", "apple-id": "apple", "myapple": "apple",
    "icloud-login": "icloud",
    ...
    "stripepay": "stripe",
    "amex": "americanexpress", "americanexp": "americanexpress",
    # Crypto
    "binanceus": "binance", "binance-us": "binance",
    "coinbase-pro": "coinbase",
    "cryptodotcom": "cryptocom", "crypto-com": "cryptocom",
    # Streaming
    "netflixlogin": "netflix", "netflix-login": "netflix",
    "spotifymusic": "spotify",
    "disneyp": "disneyplus", "disney-plus": "disneyplus",
    "hbomax": "hbomax", "hbo": "hbomax",
    # Logistics
    "dhlexpress": "dhl",
    "fedexdelivery": "fedex",
    # PH specifics
    "cebu-pacific": "cebuair", "cebupacific": "cebuair",
    "philippineair": "pal", "philippine-airlines": "pal",
}
...
class BrandVerificationService:
    ...
    def _detect_typosquatting(self, domain: str) -> Tuple[str, str] or None:
        ...
        brands = {
            ...
            'whatsapp': 'whatsapp.com', 'messenger': 'messenger.com',
            'google': 'google.com', 'gmail': 'gmail.com', 'youtube': 'youtube.com',
            'microsoft': 'microsoft.com', 'outlook': 'outlook.com',
            'hotmail': 'hotmail.com', 'onedrive': 'onedrive.live.com',
            'azure': 'azure.microsoft.com', 'office365': 'office.com',
            'apple': 'apple.com', 'icloud': 'icloud.com', 'itunes': 'apple.com',
            ...
            'discord': 'discord.com', 'telegram': 'telegram.org',
            'signal': 'signal.org', 'viber': 'viber.com',
            'wechat': 'wechat.com', 'line': 'line.me',
            # ── Payments ─────────────────────────────────────────────────
            'paypal': 'paypal.com', 'stripe': 'stripe.com', 'wise': 'wise.com',
            'skrill': 'skrill.com', 'venmo': 'venmo.com', 'cashapp': 'cash.app',
            'zelle': 'zellepay.com', 'visa': 'visa.com', 'mastercard': 'mastercard.com',
            'americanexpress': 'americanexpress.com',
            # ── E-Commerce ───────────────────────────────────────────────
            'ebay': 'ebay.com', 'amazon': 'amazon.com', 'aliexpress': 'aliexpress.com',
            'alibaba': 'alibaba.com', 'shopify': 'shopify.com', 'etsy': 'etsy.com',
            'walmart': 'walmart.com', 'target': 'target.com', 'bestbuy': 'bestbuy.com',
            'lazada': 'lazada.com.ph', 'shopee': 'shopee.ph', 'zalora': 'zalora.com.ph',
            # ── Streaming ────────────────────────────────────────────────
            'netflix': 'netflix.com', 'spotify': 'spotify.com',
            'disneyplus': 'disneyplus.com', 'hbomax': 'max.com',
            'hulu': 'hulu.com', 'primevideo': 'primevideo.com',
            'twitch': 'twitch.tv',
            # ── Crypto ───────────────────────────────────────────────────
            'binance': 'binance.com', 'coinbase': 'coinbase.com',
            'kraken': 'kraken.com', 'kucoin': 'kucoin.com',
            'bybit': 'bybit.com', 'okx': 'okx.com',
            'gemini': 'gemini.com', 'cryptocom': 'crypto.com',
            'metamask': 'metamask.io', 'trustwallet': 'trustwallet.com',
            'opensea': 'opensea.io', 'ledger': 'ledger.com', 'trezor': 'trezor.io',
            # ── Cloud / SaaS ─────────────────────────────────────────────
            'dropbox': 'dropbox.com', 'box': 'box.com', 'slack': 'slack.com',
            'zoom': 'zoom.us', 'salesforce': 'salesforce.com',
            'github': 'github.com', 'gitlab': 'gitlab.com',
            'adobe': 'adobe.com', 'notion': 'notion.so',
            'cloudflare': 'cloudflare.com', 'godaddy': 'godaddy.com',
            'wordpress': 'wordpress.com', 'squarespace': 'squarespace.com',
            'docusign': 'docusign.com', 'hubspot': 'hubspot.com',
            # ── Gaming ───────────────────────────────────────────────────
            'steam': 'store.steampowered.com', 'epicgames': 'epicgames.com',
            'roblox': 'roblox.com', 'minecraft': 'minecraft.net',
            'blizzard': 'blizzard.com', 'ea': 'ea.com',
            'playstation': 'playstation.com', 'xbox': 'xbox.com',
            'nintendo': 'nintendo.com',
            # ── Logistics ────────────────────────────────────────────────
            'dhl': 'dhl.com', 'fedex': 'fedex.com',
            'ups': 'ups.com', 'usps': 'usps.com',
            'lbc': 'lbcexpress.com', 'jnt': 'jntexpress.com.ph',
            'ninjavan': 'ninjavan.com',
            # ── Travel ───────────────────────────────────────────────────
            'airbnb': 'airbnb.com', 'booking': 'booking.com',
            'expedia': 'expedia.com', 'airasia': 'airasia.com',
            'agoda': 'agoda.com', 'klook': 'klook.com',
            'cebuair': 'cebuair.com', 'pal': 'philippineairlines.com',
            # ── PH domestic banks ─────────────────────────────────────────
            ...
            'coins': 'coins.ph', 'uniondigitalbank': 'uniondigitalbank.io',
            # ── PH government ────────────────────────────────────────────
            'sss': 'sss.gov.ph', 'gsis': 'gsis.gov.ph',
            'pagibig': 'pagibig.gov.ph', 'philhealth': 'philhealth.gov.ph',
            'bir': 'bir.gov.ph', 'lto': 'lto.gov.ph',
            'psa': 'psa.gov.ph', 'dfa': 'dfa.gov.ph', 'comelec': 'comelec.gov.ph',
            # ── PH telco ─────────────────────────────────────────────────
            'globe': 'globe.com.ph', 'smart': 'smart.com.ph',
            'pldt': 'pldt.com', 'dito': 'dito.ph', 'converge': 'convergeict.com',
            # ── Intl banks ─────────────────────────────────────────────────
            'citibank': 'citibank.com', 'hsbc': 'hsbc.com.ph',
            'maybank': 'maybank.com', 'standardchartered': 'sc.com',
            'mufg': 'mufg.jp', 'bankofamerica': 'bankofamerica.com',
            'jpmorgan': 'jpmorgan.com', 'deutschebank': 'db.com',
            'wellsfargo': 'wellsfargo.com', 'barclays': 'barclays.com',
            'santander': 'santander.com', 'commbank': 'commbank.com.au',
            'dbs': 'dbs.com', 'ocbc': 'ocbc.com', 'uob': 'uob.com',
            'capitalone': 'capitalone.com',
            # ── Insurance ────────────────────────────────────────────────
            'sunlife': 'sunlife.com.ph', 'aia': 'aia.com.ph',
            'prulife': 'prulifeuk.com.ph', 'insularlife': 'insularlife.com.ph',
            # ── Food / Delivery ──────────────────────────────────────────
            'foodpanda': 'foodpanda.com.ph', 'grab': 'grab.com',
            'jollibee': 'jollibee.com.ph', 'mcdonalds': 'mcdonalds.com.ph',
        }
